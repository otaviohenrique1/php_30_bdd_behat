...
Funcionalidade: Cadastro de formações
  ...
  @unidade
  Cenario: Cadastro de formação com 1 palavra
    Quando eu tentar criar uma formação com a descrição "PHP"
    Então eu vou ver a seguinte mensagen de erro "Descrição precisa ter pelo menos 2 palavras"
  
  @unidade
  Cenario: Criação de formação válida
  ...
  @integracao
  Cenario: cadastro de formação válida deve salvar no banco
